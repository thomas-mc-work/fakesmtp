...
final class SMTPAuthHandler implements AuthenticationHandler {
    ...
    static final String USER_IDENTITY = "User";
    // VXNlcm5hbWU6 is base64 for "Username:"
    static final String PROMPT_USERNAME = "334 VXNlcm5hbWU6";
    // UGFzc3dvcmQ6 is base64 for "Password:"
    static final String PROMPT_PASSWORD = "334 UGFzc3dvcmQ6";
     ...
     * </p>
     *
     * @return <code>null</code> if the authentication process is finished, otherwise a string to hand back to the
     * client.
    ...
    public String auth(final String clientInput) {
        ...
        switch (pass) {
            case 1:
                return SMTPAuthHandler.PROMPT_USERNAME;
            case 2:
                return SMTPAuthHandler.PROMPT_PASSWORD;
            default:
                pass = 0;
                return null;
        }
    ...
    /**
     * If the authentication process was successful, this returns the identity of the user. The type defining the
     * identity can vary depending on the authentication mechanism used, but typically this returns a String username.
